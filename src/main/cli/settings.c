...
// PG_GYRO_CONFIG
    ...
    { "dyn_lpf_gyro_rpm_mode",      VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, dyn_lpf_gyro_rpm_mode) },
#endif
...
// PG_PID_PROFILE
    ...
    { "dyn_lpf_dterm_rpm_mode",     VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, dyn_lpf_dterm_rpm_mode) },
#endif
